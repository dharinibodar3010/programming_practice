...
<div class="container">
  ...
  <form action="otpcheck.jsp">
    ...
    <!-- opt duration -->
    <div id="timerDiv" style="margin-top: 15px; color: #6a5af9; font-weight: bold;">
    Time remaining: <span id="timer">60</span>s
</div>
<div id="resendDiv" style="display: none; margin-top: 15px;">
    OTP nathi malyo? <a href="register.jsp" style="color: red; text-decoration: underline;">Resend OTP</a>
</div>
